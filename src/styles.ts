...
/* ═══════════════════════════════════════════
   SHARED STYLES
   ═══════════════════════════════════════════ */
export const S_BTN: React.CSSProperties = { padding: `${SP.xs}px ${SP.lg}px`, fontSize: FS.lg, border: `1px solid ${C.border}`, background: C.bgPanel, color: C.textMuted, borderRadius: R.lg, cursor: "pointer", transition: `background ${DUR.fast}, border-color ${DUR.fast}, color ${DUR.fast}`, display: "inline-flex", alignItems: "center", justifyContent: "center" };
...
export const S_TAB_ACTIVE: React.CSSProperties = {
  padding: `${SP.md}px ${SP.xl}px`, fontSize: FS.xl, fontWeight: FW.bold,
...
export const S_TAB_INACTIVE: React.CSSProperties = {
  padding: `${SP.md}px ${SP.xl}px`, fontSize: FS.xl, fontWeight: FW.normal,
